...
int ca2d_network_pointers (ca2d_t ca2d, int unsigned py [2] [(size_t) pow (ca2d.sts, ca2d.ngb.y * ca2d.ngb.x)], int unsigned px [2] [(size_t) pow (ca2d.sts, ca2d.ngb.y * ca2d.ngb.x)]);
